...
macro( setupPluginFileFromTemplate BUILD_TYPE OGRE_USE_SCENE_FORMAT )
	...
	if( ${BUILD_TYPE} STREQUAL "Debug" )
		configure_file( ${CMAKE_SOURCE_DIR}/cmake/Templates/Plugins.cfg.in ${CMAKE_BINARY_DIR}/bin/plugins_d.cfg )
	else()
...
function( setupResourceFileFromTemplate )
	...
	configure_file( ${CMAKE_SOURCE_DIR}/cmake/Templates/Resources.cfg.in ${CMAKE_BINARY_DIR}/bin/Data/resources2.cfg )
endfunction()
...
file( COPY "${OGRE_SOURCE}/Samples/Media/Hlms/Common"	DESTINATION "${CMAKE_BINARY_DIR}/bin/Data/Hlms" )
file( COPY "${OGRE_SOURCE}/Samples/Media/Hlms/Pbs"		DESTINATION "${CMAKE_BINARY_DIR}/bin/Data/Hlms" )
file( COPY "${OGRE_SOURCE}/Samples/Media/Hlms/Unlit"	DESTINATION "${CMAKE_BINARY_DIR}/bin/Data/Hlms" )

message( STATUS "Copying Common data files from Ogre repository" )
file( COPY "${OGRE_SOURCE}/Samples/Media/2.0/scripts/materials/Common"	DESTINATION "${CMAKE_BINARY_DIR}/bin/Data/Materials" )
