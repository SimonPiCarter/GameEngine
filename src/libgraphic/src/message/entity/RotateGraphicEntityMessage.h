...
class RotateGraphicEntityMessage : public GraphicMessage
{
public:
	///
	/// @brief create
	/// @param entity_p the entity to move
	/// @param vector_p the vector with the coordinate to rotate the Entity
	RotateGraphicEntityMessage(GraphicEntity * entity_p, std::array<double, 3> const &vector_p);
